...
public class InstantiatePlayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player.GetComponentInChildren<PlayerMovmentJoystick>().enabled = true;
        player.GetComponentInChildren<PlayerMovmentJoystick>().Init();
        player.GetComponentInChildren<CharacterBase>().Init();
        player.GetComponentInChildren<MoveVelocity>().Init();
        player.GetComponentInChildren<CharacterBase>().enabled = true;
        player.GetComponentInChildren<MoveVelocity>().enabled = true;
